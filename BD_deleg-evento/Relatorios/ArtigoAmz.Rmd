...
```{r importando_bases, warning=FALSE, results='hide',message=FALSE}
## Importando os dados ------------
...
```{r integrando_bases, warning=FALSE, results='hide',message=FALSE}
...
```{r limpando_base_eventos, warning=FALSE, results='hide',message=FALSE}
...
```{r preparandobase_deleg_evento, warning=FALSE, results='hide',message=FALSE}
...
```{r limpeza_environment, include=FALSE}

...
```{r plot ditadura, echo = F, message = F}
...
```{r plot sarney, echo = F, message = F}
#.... Generating the figure ------
...
```{r plot lula2, echo = F, message = FALSE}
#.... Generating the figure ------
